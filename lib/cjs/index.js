...
function Select(props) {
    ...
    var Options = options.map(function (option) {
        return (jsxRuntime.jsx("div", __assign$1({ className: "option", onClick: function () { return handleChange(option); } }, { children: jsxRuntime.jsx("span", { children: option.label }) }), v4()));
    });
