...
const FormBuilder = (props) => {
    ...
    const InputsData = configInputs(Object.assign(Object.assign({}, props), { payload,
        shouldClear, setFormContent: setPayload }));
    const Inputs = InputsData.map((i) => i.component);
    const onClickSubmit = () => {
        const errors = InputsData.map((i) => { var _a; return (_a = i.ref.current) === null || _a === void 0 ? void 0 : _a.getErrorMessage(); });
