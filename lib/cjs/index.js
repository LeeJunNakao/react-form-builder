...
var Input = function (props) {
    ...
    return (jsxRuntime.jsx("div", __assign$1({ className: "input-component-wrapper" }, { children: jsxRuntime.jsx("input", { type: props.type, className: "input-component", value: value, placeholder: props === null || props === void 0 ? void 0 : props.placeholder, onChange: handleContent }) })));
};
...
var Month = function (props) {
    ...
    return (jsxRuntime.jsxs("div", __assign$1({ className: "calendar-month", "data-type": "calendar" }, { children: [jsxRuntime.jsx("input", { type: "button", value: "<", onClick: props.goPrevious, className: "calendar-arrow" }), jsxRuntime.jsx("span", __assign$1({ className: "month-name" }, { children: monthName })), jsxRuntime.jsx("input", { type: "button", value: ">", onClick: props.goNext, className: "calendar-arrow" })] })));
};
...
var Multiselect = function (props) {
    ...
    var Options = options.map(function (option) {
        ...
        return (jsxRuntime.jsxs("div", __assign$1({ className: "option", onClick: function () { return handleChange(option); } }, { children: [jsxRuntime.jsx(Icon, {}), " ", jsxRuntime.jsx("span", { children: option.label })] }), uuid.v4()));
    });
    var EmptyMessage = (jsxRuntime.jsx("div", __assign$1({ className: "option empty-message" }, { children: jsxRuntime.jsx("span", { children: "No options " }) })));
    return (jsxRuntime.jsxs("div", __assign$1({ className: "select-component-wrapper", onClick: handleClick, onBlur: handleBlur, tabIndex: 0, ref: componentRef }, { children: [jsxRuntime.jsxs("div", __assign$1({ className: "select-input" }, { children: [jsxRuntime.jsx("div", __assign$1({ className: "select-content" }, { children: contentDisplay.join(", ") })), isOpened ? (jsxRuntime.jsx(MdArrowDropUp, { className: "arrow-icon" })) : (jsxRuntime.jsx(MdArrowDropDown, { className: "arrow-icon" }))] })), jsxRuntime.jsx("div", __assign$1({ className: "options-wrapper", ref: optionsWrapperRef }, { children: isOpened && (jsxRuntime.jsx("div", __assign$1({ className: "select-options", ref: optionsRef, tabIndex: 0 }, { children: options.length ? Options : EmptyMessage }))) }))] })));
};
