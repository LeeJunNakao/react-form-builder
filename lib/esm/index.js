...
var Input = function (props) {
    ...
    return (jsx("div", __assign$1({ className: "input-component-wrapper" }, { children: jsx("input", { type: "text", className: "input-component", value: value, placeholder: props === null || props === void 0 ? void 0 : props.placeholder, onChange: handleContent }) })));
};
...
var YearBox = function (props) {
    ...
    return (jsxs("div", __assign$1({ className: "calendar-header" }, { children: [jsx("input", { type: "button", value: "<", onClick: props.goPrevious, className: "calendar-arrow" }), edit ? (jsx("input", { className: "edit-year-input", onKeyDown: handlePress, onChange: handleChange, value: year })) : (jsx("span", __assign$1({ onClick: function () { return setEdit(true); } }, { children: props.year }))), jsx("input", { type: "button", value: ">", onClick: props.goNext, className: "calendar-arrow" })] })));
};
...
var Month = function (props) {
    ...
    return (jsxs("div", __assign$1({ className: "calendar-month" }, { children: [jsx("input", { type: "button", value: "<", onClick: props.goPrevious, className: "calendar-arrow" }), jsx("span", __assign$1({ className: "month-name" }, { children: monthName })), jsx("input", { type: "button", value: ">", onClick: props.goNext, className: "calendar-arrow" })] })));
};
